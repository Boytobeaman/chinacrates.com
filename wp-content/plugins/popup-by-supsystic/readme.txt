...
Tags: full screen popup, html popup, popup, pop up, wordpress popup, popup contact form, popup builder, modal window, video popup, youtube popup, social popup, fly-in
Tested up to: 4.5.3
Stable tag: 1.7.6

The Best WordPress Popup optin plugin to help you gain more subscribers, social followers. Responsive popup with optin and social lock. Popup A/B test

== Description ==

[Popup by Supsystic](http://supsystic.com/plugins/popup-plugin?utm_source=wordpress&utm_medium=description&utm_campaign=popup "Popup WordPress plugin Supsystic") lets you easily create elegant overlapping windows with unlimited features. popup with Subscription Forms, Social Buttons, Contact Form, Google Map, Slider, Lightbox and more:

* Theme Popup Builder. Popup customization with several clicks.
* Responsive Mobile Freindly popup
...
* [Exit-intent popup](http://supsystic.com/exit-popup/ "On Exit Popup") allow you to capture lost visitors (pro)
* Optin and Social Lock Options
* [A/B Split Tests and Statistic](http://supsystic.com/what-is-ab-testing/ "Popup A/B Split Tests") (pro)
...
* Facebook Popup
* Age Restriction Popup (pro)
* Full Screen Popup
* iFrame Popup
* PDF Popup 
* HTML Popup 

Popup maker with live preview let you customize pop-up templates without programming skills. Plugin allows you to create popup with any type of content:
...
Using popup windows was once frowned on as a ploy used by marketers who were just out to grab your cash, but it has entered the mainstream, with large scale and legitimate business and website owners using popup to gather email addresses, ask for social network shares such as Facebook likes, or to promote the latest and greatest product/service.

= Delayed Pop-Ups =

Not all popup are necessary as soon as a page loads. Consider a delayed pop-up for your site. There are a variety of options for this, including pop ups that only show on scroll, on click, or after a certain amount of time on the WordPress site.
...
popup work… really, really, really well. I’ve yet to see a case study where optin popup decreased the site’s conversion rate, and I’ve seen countless case studies where popup catapulted CRO by as high as 250 - 400%.
...
popup allow you to stick a CTA front and center, demanding an action. If readers liked your content, they will be much more likely to give you their email when asked then to search your site for a sidebar popup social subscription box. 
...
Main popup options
    ...
    When to show popup:
        when page load and set the popup delay in seconds;
        when user click on the popup page;
        when user click on certain link / button / other element – you need copy & paste short code of popup – into required link to open PopUp on Click. Or, if you know HTML basics, – you can insert “onclick” attribute to any of your element from popup code;
        when user scroll window;
        on popup exit from site
    Whom to show popup:
    Show popup on next pages:
        all pages;
        select pages on which to show popup;
        select pages on which don’t show popup

Design popup tab

This popup tab allows you –

    Change appearance of your popup:
        set the width of popup – in pixels or percents;
        specify the popup background overlay opacity of popup;
        set popup image or color for backgrounds of blocks in popup;
        choose close popup button – includes a wide range of buttons;
        choose bullets for text blocks of popup
    Enable popup Subscription:

    At first choose where to subscribe with popup – WordPress, Aweber, MailChimp, etc.

    If you select popup subscription to WordPress, you have the ability to create users after subscribe with special roles – Subscriber, Author, Contributor.

    In order to subscribe popup to Aweber you need to enter unique list id –  check this page for more details.

    To subscribe to MailChimp you need enter your MailChimp API key and name of list for subscribe.
	
Obviously, some would say that popup depends on the traffic, but actually, traffic alone is not everything. Often the goal popup for a website is to generate sales with popup, increase subscription rates, and develop loyal readership. Internet marketers are more familiar to this principle than any others are working online, and part of their success formula is the use of forceful and effective call to action popup. Popup is one of the main tools of internet marketer to increase subscription rates.

The results of our research confirms that Popup plugin really helps to increase site traffic, its subscribers. Accordingly popup promotes to a significant increase in sales. More subscribers – more sales! It’s that simple with Popup by Supsystic!
...
= Contact Form Popup =
Your task is very simple to insert the shortcode of the ready-made contact form to PopUp and that’s all. Don’t forget that you can customize at the same time contact form (background image, font, color) and popup (size, template, time).

This theme of contact form popup allows an user to create and add the popup contact forms easily on the WordPress website and it is good to see the contact form on popup. We can add the image button link or text link in all the pages that popup the contact form. That popup contact form let an user to send the emails to administration page and it is available to manage the site admin email address.

= Exit Intent Popup =
If you are starting or already running and online store, you must be ready to accept the fact that about 95 visitors out of 100 will leave your website without buying. On the other hand, that leaves a potential for getting at least a share of the leaving visitors to buy a thing immediately or a bit later. The Exit Intent Popup WordPress does exactly that.

= Video PopUp =
 An elegant lightbox overlay shows your Youtube or Vimeo videos. Display the content in XXI century – show the tutorials, advertising, reviews and at least your team – Video Popup for WordPress. PopUp by Supsystic makes your WordPress page or blog stylish and increase the level of the customers’ condescension. WordPress Video PopUp for people who like changes and change. Follow the next steps to create and choose your Video PopUp:
1. Choose Popup by Supsystic on your admin panel of the WordPress admin page
2. Click the insert “Add New PopUp” and choose there Video theme! You have two variations: the classy one and the list. Choose the ever you want.

= Social Popup =
The popularity of your site today can’t be imagined without social networks. Adults and teenagers, even kids today are really addicted on them – so we offer you Social Popup by Supsystic. Link your site with social media: Youtube, Facebook, Twitter, Google profile or any else. WordPress Social Popup for you site can be easily installed even by not professional programmer. We created it for the average user without coding knowledge.
Social Popup is the best idea to welcome your visitors for website interaction. You can use our simple social popup like box to show your Facebook, twitter or Google profile. If you are using WordPress platform it is not hard to make it. Your visitors must know about your Facebook pages, Twitter profile, Pinterest pages or Google + page!

= Age Restriction Popup =
Age restriction popup helps for every site with adult content. But sometimes it’s also a tool for gathering the info about the main category of users, who visit your site. Age restriction popup by Supsystic offers you the maximum result with minimum efforts. WordPress Age restriction Popup has nothing redundant: two- three buttons and the info is in your pocket! As about Age restriction popup from this plugin – the theme is very popular not only for its usability but for minimalistic design and a long queue of functionality.

= Countdown Popup =
Our WordPress Countdown plugin allows website owners to create nice and functional Countdown popup timer just in a few minutes, clicks and with a few steps. This is the best way to create beautiful Countdown popup for your users, their sites and pages. You can use our Countdown popup timer theme in your posts/pages and widgets. It’s very easy to use and there isn’t any need of coding knowledge for creating such a great fun.
The very installation process looks like this: Choose the directory “Popup By Supsystic” on the black admin panel of your WordPress site/page
“Add New Popup” button clicking will open a page with creating modules. Click there on Countdown popup theme, don’t forget about title of it and the Save button

= Iframe PopUp =
One of the main themes for Popup plugin by Supsystic is an Iframe PopUp. Choose it if you want a very slight, laconic design for the minimalistic sites. Iframe popup plugin was specially developed to display any web page in the popup window using web URL. It uses fancy box to display popup in iframe. So that Iframe PopUp is an ideal variant for your site, if you want to showcase the content of your age, not the bright design.

= Can we show popup only when user is scrolling? =
Yes, of course. Your choice is Main insert of our Settings and a directory “When To Show PopUp”, there find an option Scroll Window (choose the delay and percents of total scroll). The option to show popup when user is scrolling maybe useful on every site. It will attract the attention of user, who is scrolling it without any thoughts or don’t want to buy some products. The best place for advertisement, discounts or even subscriptions tables is popup by Supsystic.

= Can Popup been shown only per visitors? =
Yes, of course. If you want to make this option please, follow the instruction:
How to find the option – Show PopUp once per visitor, if you want to make PopUp with such a feature?
...
Then you will see another window with several option inserts like: “Main”, “Design”, “Login/Registration”, “A/B Testing”, “Statistics”, “CSS/HTML Code”.
Your choice is Main insert and a directory “Whom To Show PopUp”, there find an option For the first-time visitor (don’t forget to choose the period, for which our plugin should remember this task).

= Can we show popup only on mobile devices? =
Yes, choose please,the Main insert in the Settings area of our plugin and a directory “Whom To Show PopUp”, there find an option Show/Hide on devices and choose what it should be – tablet, phone etc.

= Is autoclose of Popup avalaible? =
Yes, it is supereasy to close it without any action. Please, choose the directory "When to close PopUp" and choose the option you need.

= *Disable Popup without action  - how to do it? =
How to make your Popup not to be closed in several seconds, while user is staying on the site-page? Waiting till some user-action
If you want to choose and create your new Popup in this style, follow the next steps:

Choose Popup by Supsystic on your admin panel of the WordPress admin page
Find there an insert “Add new PopUp” and choose Iframe theme. Don’t forget to click Simple iFrame icon.
Type the name of future Popup and click the button “Save”.
Then you will see another window with several option inserts like: “Main”, “Design”, “Login/Registration”, “A/B Testing”, “Statistics”, “CSS/HTML Code”. Your choice is Main insert and a directory “When to close PopUp”, there find an option Only after action (Subscribe/Share/Like) or don’t forget to chose the time, after which Popup will be closed.

= Can I close PopUp after certain time? =
You can do it easy and in two=three steps. choice is Main insert and a directory “When to close PopUp”, there find an option After time passed and type the number of seconds you need.
...
Use Popup Builder and Lead Generator to compile different popup using varied content. Using Short Codes, HTML, and other codes provides popup with vide range of options. Popup Maker is similar in a way to WordPress when talking about adding content and popup.

= Using popup =

Targeting Conditions feature is designed especially to connect the modal window to a specific user and show up at a given time and place. To improve the popup' effectiveness it is better to use Auto Open or Exit Intent Popup Extensions.
...
Auto Open popup are the critical plugin that Modal Window uses when working with the WordPress Popup Plugins. The plugin has the following features:
...
Optin theme has many options to use to the advantage to make the website popup look good, like:
...
To add more content to the popup and make sure that this very content is visible to those, who are supposed to see it.

= Responsive popup =

Responsive popup tool set is used to create popup ready to be used for any device in no time, just by selecting the right option in this tool`s menu.

Small size, Reliable with wide option range.

The plugin is as light. The website work will not be damaged. popup will operate at a very high level with optimal uptime using optimization techniques and program enhancement.
...
= Popup by Supsystic 1.7.6 / 21.07.2016 =
...
= Popup by Supsystic 1.7.5 / 21.06.2016 =
...
= Popup by Supsystic 1.7.4 / 07.06.2016 =
...
= Popup by Supsystic 1.7.2 / 17.05.2016 =
...
= Popup by Supsystic 1.7.1 / 28.04.2016 =
...
= Popup by Supsystic 1.7.0 / 19.04.2016 =
...
= Popup by Supsystic 1.6.4 / 29.03.2016 =
...
= Popup by Supsystic 1.6.3 / 22.03.2016 =
...
= Popup by Supsystic 1.6.2 / 17.03.2016 =
...
= Popup by Supsystic 1.6.1 / 14.03.2016 =
...
= Popup by Supsystic 1.6.0 / 02.03.2016 =
...
= Popup by Supsystic 1.5.9 / 25.02.2016 =
...
= Popup by Supsystic 1.5.8 / 23.02.2016 =
...
= Popup by Supsystic 1.5.7 / 16.02.2016 =
...
= Popup by Supsystic 1.5.6 / 02.02.2016 =
...
= Popup by Supsystic 1.5.5 / 26.01.2016 =
...
= Popup by Supsystic 1.5.4 / 13.01.2016 =
...
= Popup by Supsystic 1.5.3 / 21.12.2015 =
...
= Popup by Supsystic 1.5.2 / 14.12.2015 =
...
= Popup by Supsystic 1.5.1 / 08.12.2015 =
...
= Popup by Supsystic 1.5.0 / 03.12.2015 =
...
= Popup by Supsystic 1.4.6 / 17.11.2015 =
...
= Popup by Supsystic 1.4.5 / 10.11.2015 =
...
= Popup by Supsystic 1.4.4 / 05.11.2015 =
...
= Popup by Supsystic 1.4.3 / 03.11.2015 =
...
= Popup by Supsystic 1.4.2 / 27.10.2015 =
...
= Popup by Supsystic 1.4.1 / 21.10.2015 =
...
= Popup by Supsystic 1.4.0 / 13.10.2015 =
...
= Popup by Supsystic 1.3.9 / 06.10.2015 =
...
= Popup by Supsystic 1.3.8 / 28.09.2015 =
...
= Popup by Supsystic 1.3.7 / 24.09.2015 =
...
= Popup by Supsystic 1.3.6 / 22.09.2015 =
...
= Popup by Supsystic 1.3.5 / 17.09.2015 =
...
= Popup by Supsystic 1.3.4 / 12.09.2015 =
...
= Popup by Supsystic 1.3.3 / 08.09.2015 =
...
= Popup by Supsystic 1.3.0 / 13.08.2015 =
...
= Popup by Supsystic 1.2.7 / 24.07.2015 =
...
= Popup by Supsystic 1.2.6 / 16.07.2015 =
...
= Popup by Supsystic 1.2.2 / 04.06.2015 =
...
= Popup by Supsystic 1.2.1 / 29.05.2015 =
...
= Popup by Supsystic 1.2.0 / 19.05.2015 =
...
= Popup by Supsystic 1.1.9 / 07.05.2015 =
 * Code popup review
 * Minor popup issues fix

= Popup by Supsystic 1.1.8 / 30.04.2015 =
...
= Popup by Supsystic 1.1.7 / 23.04.2015 =
...
= Popup by Supsystic 1.1.6 / 14.04.2015 =
...
= Popup by Supsystic 1.1.5 / 07.04.2015 =
...
= Popup by Supsystic 1.1.4 / 01.04.2015 =
...
= Popup by Supsystic 1.1.3 / 24.03.2015 =
...
= Popup by Supsystic 1.1.2 / 20.03.2015 =
...
= Popup by Supsystic 1.1.1 / 10.03.2015 =
...
= Popup by Supsystic 1.1.0 / 05.03.2015 =
...
= Popup by Supsystic 1.0.9 / 24.02.2015 =
